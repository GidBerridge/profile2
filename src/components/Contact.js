...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative">
      <div className="container bg-gray-900 px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
      <div className="relative flex flex-wrap py-6 rounded shadow-md">
        ...
        {/* <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          <iframe
            ...
            src="https://www.google.com/maps/embed/v1/place?q=Turnpike+Lane&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
          />
        ...
        <form
          ...
          <p className="leading-relaxed mb-5">
            Need a website? Help with a freelance project? short term, long term or permanent position filled? Let me know...
          </p>
